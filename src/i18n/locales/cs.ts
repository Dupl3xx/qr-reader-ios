export default {
  ...
  settings: {
    ...
    multiScan: 'Více kódů',
    multiScanDesc: 'Když je vidět více kódů najednou',
    multiScanSingle: 'Skenovat jen první',
    multiScanAll: 'Skenovat vše a uložit do historie',
    multiScanChoose: 'Nechat mě vybrat',
    multiScanFound: 'nalezených kódů',
    multiScanSaved: 'Všechny kódy uloženy do historie',
